...
const style = { color: '#ee4d2d', fill: 'currentColor', width: '1.3125rem', height: '1.25rem' };

const VoucherIcon: React.FunctionComponent<VoucherIconProps> = (props) => {
  return (
    <svg style={style} fill="none" viewBox="0 -2 23 22">
