        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(2335)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(3155)),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "admin"),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 1, 18, 21, 35, 19, 776, DateTimeKind.Local).AddTicks(8678)),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "admin"),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 1, 18, 21, 35, 19, 776, DateTimeKind.Local).AddTicks(4280)),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "admin"),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 1, 18, 21, 35, 19, 776, DateTimeKind.Local).AddTicks(5080)),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "admin"),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(2481), false, "Dell", "admin", null },
                    { 2, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(2483), false, "Apple", "admin", null },
                    { 3, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(2485), false, "Gigabyte", "admin", null },
                    { 4, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(2486), false, "Corsair", "admin", null },
                    { 5, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(2487), false, "LG", "admin", null },
                    { 6, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(2488), false, "Asus", "admin", null },
                    { 7, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(2489), false, "Viewsonic", "admin", null },
                    { 8, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(2490), false, "Acer", "admin", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(3294), false, "Laptop", "admin", null },
                    { 2, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(3296), false, "Ipad", "admin", null },
                    { 3, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(3298), false, "Screen", "admin", null },
                    { 4, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(3342), false, "Iphone", "admin", null },
                    { 5, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(3343), false, "Macbook", "admin", null },
                    { 6, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(3344), false, "Mainboard", "admin", null },
                    { 7, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 777, DateTimeKind.Local).AddTicks(3345), false, "Case", "admin", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "94a12a30-1a9b-48ad-950d-29f80865003d", 0, "TP Ho Chi Minh", null, "48bbe0e9-0e72-426a-bba2-9e0dc681ae9a", null, false, "mangoc", false, null, null, null, null, null, false, "4e67a456-cab1-4e25-aabc-5bf67981fb9a", false, null },
                    { "d68dcb5f-2706-4cb5-bb0b-37bf39400420", 0, "TP Ho Chi Minh", null, "8330cccd-151f-4c90-b6c7-0a5704bf7a46", null, false, "kiethuynh", false, null, null, null, null, null, false, "9766692f-566d-4be2-9d92-410ce086947f", false, null },
                    { "f222bfbf-86bf-4b65-9958-bc818ba5f822", 0, "TP Ho Chi Minh", null, "6980319a-ca3e-451c-adc5-47309660ce17", null, false, "auduongphong", false, null, null, null, null, null, false, "2574a62d-2838-4cc8-af88-4978f4f1e0db", false, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 776, DateTimeKind.Local).AddTicks(4469), false, "admin", null, "d68dcb5f-2706-4cb5-bb0b-37bf39400420" },
                    { 2, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 776, DateTimeKind.Local).AddTicks(4472), false, "admin", null, "94a12a30-1a9b-48ad-950d-29f80865003d" },
                    { 3, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 776, DateTimeKind.Local).AddTicks(4474), false, "admin", null, "f222bfbf-86bf-4b65-9958-bc818ba5f822" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 776, DateTimeKind.Local).AddTicks(7775), false, 1, 3, 1, "admin", null },
                    { 2, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 776, DateTimeKind.Local).AddTicks(7780), false, 2, 3, 1, "admin", null },
                    { 3, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 776, DateTimeKind.Local).AddTicks(7781), false, 3, 3, 1, "admin", null },
                    { 4, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 776, DateTimeKind.Local).AddTicks(7782), false, 1, 3, 2, "admin", null },
                    { 5, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 776, DateTimeKind.Local).AddTicks(7783), false, 2, 3, 2, "admin", null },
                    { 6, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 776, DateTimeKind.Local).AddTicks(7785), false, 3, 3, 2, "admin", null },
                    { 7, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 776, DateTimeKind.Local).AddTicks(7786), false, 1, 3, 3, "admin", null },
                    { 8, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 776, DateTimeKind.Local).AddTicks(7787), false, 2, 3, 3, "admin", null },
                    { 9, "admin", new DateTime(2024, 1, 18, 21, 35, 19, 776, DateTimeKind.Local).AddTicks(7789), false, 3, 3, 3, "admin", null }
                });
